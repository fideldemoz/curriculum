...
5. This [How Promises Work in JavaScript](https://www.freecodecamp.org/news/guide-to-javascript-promises) from FreeCodeCamp is also a great article to gain an in-depth understanding of promises (and async operations).
